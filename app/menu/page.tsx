...
const menuItems = [
  {
    ...
    description: "Crispy golden fries served with juicy fried beef sausages, a Kenyan favorite snack",
    price: "Ksh500",
    dietary: ["Seafood"],
    image: "/dish13.jpg",
  },
  {
    ...
    description: "Tender chicken pieces pan-fried with onions, tomatoes, and spices for a rich homely taste",
    price: "Ksh1800",
    dietary: [],
    image: "/dish2.jpg",
  },
  {
    category: "Starters",
    name: "Dry-Fry Beef",
    description: "Succulent beef cubes dry-fried with onions, chili, and coriander — a bar snack classic.",
    price: "Ksh1300",
    dietary: ["Vegetarian"],
    image: "/dish3.jpg",
  },
  {
    ...
    description: "Juicy chicken simmered in a tomato-onion gravy with Kenyan spices, perfect with ugali or rice.",
    price: "Ksh1800",
    dietary: [],
    image: "/dish4.jpg",
  },
  {
    ...
    description: "Crispy chicken dry-fried with onions, garlic, chili, and dhania for bold Kenyan flavor.",
    price: "Ksh1800",
    dietary: ["Seafood"],
    image: "/dish6.jpg",
  },
  {
    category: "Mains",
    name: "Dry-Fry Mutton",
    description: "Hearty mutton slow-cooked then dry-fried with ginger, garlic, and onions — rich and filling.",
    price: "Ksh1400",
    dietary: [],
    image: "/dish5.jpg",
  },
  {
    category: "Mains",
    name: "Pan-Fry Chicken",
    description: "Pan-seared chicken with a light onion-tomato base, full of Kenyan street-food character.",
    price: "Ksh1800",
    dietary: ["Vegetarian"],
    image: "/dish7.jpg",
  },
  {
    category: "Desserts",
    name: "Sausages",
    description: "Crispy fried beef sausages, a light and savory treat to close your meal.",
    price: "Ksh200",
    dietary: ["Vegetarian"],
    image: "/dish12.jpg",
  },
  {
    category: "Desserts",
    name: "French Fries with Sausage",
    description: "Kenyan-style chips and sausage combo, a simple yet beloved comfort bite.",
    price: "Ksh500",
    dietary: ["Vegetarian"],
    image: "/dish11.jpg",
  },
  {
    category: "Desserts",
    name: "Pan-Fry Chicken",
    description: "A smaller portion of pan-fried chicken, perfect as a savory alternative to sweets.",
    price: "Ksh900",
    dietary: ["Vegetarian"],
    image: "/dish6.jpg",
  },
  {
    ...
    description: "A curated choice of local and international wines to pair perfectly with your meal.",
    price: "Ksh5000",
    dietary: [],
    image: "/wine2.jpg",
  },
  {
    category: "Drinks",
    name: "Martel",
    description: "Premium cognac or cocktail mix, crafted for an elegant dining experience.",
    price: "Ksh3000",
    dietary: [],
    image: "/wine1.jpg",
  },
